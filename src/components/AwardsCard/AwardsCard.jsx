...
const AwardsCard = ({ award }) => {
  ...
  return (
    <article
      className={`award-card ${isOpen ? "is-open" : ""}`}
    >
      <div className="award-card__layout">
        <div className="award-card__left">
          <div className="award-card__info">
            ...
            <h2 className="award-card__title">
              {award.title}
            </h2>
            <p className="award-card__year">
              {award.year}
            </p>
          </div>
          <button
              ...
              {award.categories?.map(
                (category, index) => (
                  ...
                  >
                    ...
                    <span className="award-card__winner">
                      {category.winner}
                    </span>
                  </div>
                )
